...
def jugar():
    ...
    tipos_de_palabras = [
                          [sg.T('', background_color='dark slate gray')],
                          [sg.Text(" Sustantivos  "+str(data["cantidad"]['Sustantivos']) + '  ',
                            text_color='black', 
                            ...
                            sg.Radio('', "RADIO1",
                              ...
                              default=True,
                              background_color='dark slate gray')],
                           [sg.Text(" Verbos       "+str(data["cantidad"]['Verbos']) + '  ',
                            text_color='black', 
                            font=('Courier', 12, 'bold'),
                            background_color='dark slate gray'),
                            sg.T(
                           ...
                           [sg.Text(" Adjetivos    "+str(data["cantidad"]['Adjetivos']) + '  ',
                            text_color='black', 
                            font=('Courier', 12, 'bold'),
                            background_color='dark slate gray'),
                            sg.T(
